...
public class ConnectorImpl<T, TPlugin>
	extends CommonConnectorImpl<FilterDef<T, TPlugin>>
	implements Connector<T, TPlugin>
{
	...
	public ConnectorImpl(IPipelineContext ctxt, FilterDefImpl<T, TPlugin> filterDef)
	{
